...
const PickEms = ({ matches, handleWinnerSelect, handleSend, standings, selectedWeek, handleSelectedWeek, predictions, results }) => {
    ...
    <div className='pickems-container'>
      <div className='matches-container'>
        ...
        {filteredMatches.map((match) => (
          <SelectWinners key={match.id} match={match} onWinnerSelect={handleWinnerSelect} predictions={predictions} results={results} />
        ))}
